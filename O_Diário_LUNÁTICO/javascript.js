...
const dlConfig = {
  ...
  */
  folhas: [
    ...
    sinopse:"O Multiverso. Ahhhh, sim, o CURIOSO Multiverso.\n\nEle é interessante na mesma proporção em que é gigantesco, embora “interessante” seja pouca merda para definir a beleza entediante de tooooooooda a sua vastidão.\n\nQuer saber o porquê? Então venha comigo, eu vou TENTAR te explicar da melhor forma possível!\n\nPara começar, nele existe uma quantidade infinita de realidades e universos. E não tô falando apenas da quantidade. Essa infinitude também se manifesta em sua extensão, profundidade e escala.\n\nTodos esses universos se expandem para além de qualquer noção de distância que você tente conceber, atravessando espaços tão fodidos que fim, borda e vazio se tornam coisas menos que irrelevantes. Existem também universos que são tão descomunais que fazem outros parecerem microscópicos quando colocamos esses tais lado a lado, existindo assim como mera poeira que apenas flutua em algo muito maior.\n\nCada um desses universos existente abrigam, também, incontáveis camadas de existência coexistindo simultaneamente. Entre elas, há um conjunto incontável de infinitas dimensões espaciais e temporais, responsáveis por sustentar as realidades através de eixos, direções e estruturas que atravessam tudo aquilo que existe.\n\nAcima, abaixo e entre essas dimensões, se empilham planos paralelos, sub-realidades, linhas temporais divergentes e mundos que se dobram uns dentro dos outros. E, dentro dessa caralhada de estruturas, também existem inúmeras galáxias sem fim, sistemas estelares, universos menores encapsulados em universos maiores e até estruturas inteiras escondidas dentro de partículas subatômicas. (Eu nem sabia que uma merda dessas era possível, pra você ter uma ideia.)\n\nResumindo: o Multiverso é uma sequência interminável de estruturas infinitas contidas dentro de estruturas infinitas ainda maiores, repetindo-se em escalas cada vez mais insanas como espirais infinitas que continuam se aprofundando sem nunca chegar a porra nenhuma.\n\nBlá, blá, blá. “Infinito” pra lá, “infinito” pra lá. Blá, blá, blá. Meu Deus, eu devo ter repetido esse mesmo termo tantas vezes que acho que um professor de escrita se mataria na minha frente.\n\nMas fazer o que? É literalmente isso, não tem outra forma de descrever. Então meus pêsames pra ele.\n\nA propósito, acho bom que você tenha entendido tudo até aqui. Se não entendeu, eu não vou explicar de novo.\n\nCOOOONTINUANDO!\n\nNesse oceano interminável de possibilidades, cada realidade se sustenta através de suas próprias leis, lógicas e narrativas. Algumas seguem princípios relativamente familiares, espelhando aquilo que nós entendemos como física, lógica e ciência. Outras, no entanto, são completamente alienígenas e esquisitas pra um caralho: mundos onde o tempo flui em incontáveis direções ao mesmo tempo; universos onde a existência se fragmenta em versões contraditórias de si mesma; realidades onde identidade, matéria e consciência deixam de ser simples ideias fixas.\n\nMas onde eu quero chegar com isso, você quer saber? O que toda essa droga sobre o multiverso tem a ver com essa história?\n\nÉ simples: infinitas possibilidades é igual a infinitas vidas!\n\nOu seja, existem VÁÁÁÁÁRIAS Miskas espalhadas por esse vasto e entediante multiverso. Cada uma com diferentes vidas, diferentes escolhas; Diferentes tragédias, vitórias, fracassos e versões de quem ela poderia ter sido. Algumas são quase idênticas à que conhecemos, enquanto outras são tão bizarras que mal poderiam ser reconhecidas como a mesma pessoa.\n\nE, por culpa de um CERTO alguém, a nossa velha e conhecida Miska descobrirá isso ao vivo e a cores.. entrevistando elas!\n\nO que poderia dar errado, não é?\n\nAhem! NÃO É???"
  },
