...
const dlConfig = {
  ...
  */
  folhas: [
    ...
    sinopse:"No multiverso, existem uma quantidade infinita de realidades e universos, não apenas em número, mas em extensão.\n\nDentro desse oceano interminável de possibilidades, cada realidade se sustenta por suas próprias regras, leis e narrativas.\n\nAlgumas seguem princípios familiares, ecoando o que entendemos como física e lógica. Outras, porém, são completamente alienígenas, onde o tempo pode fluir em várias e várias direções, a existência pode se fragmentar, e a própria identidade deixa de ser algo fixo.\n\nOnde eu quero chegar? Vou resumir pra você: Existem várias Miskas espalhadas por aí. E, por culpa de um certo alguém, a nossa velha e conhecida Miska descobrirá isso ao vivo e a cores.. entrevistando elas! O que poderia dar errado, né?\n\n...Né?" },
