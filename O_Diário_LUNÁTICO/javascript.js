...
const dlConfig = {
  ...
  */
  folhas: [
    ...
    sinopse:"O Multiverso.\n\nAhhh, sim. Ele é interessante na mesma proporção em que é gigantesco, mas preciso admitir que “interessante” é muita pouca merda para definir a beleza entediante de tooooooooda a sua vastidão. Quer saber o porquê?\n\n“Ehm. Na verdade, eu quero saber como você entrou na minha casa.”\n\nÓtimo! Vem! Chega mais perto, não chame a polícia! Eu vou tentar te explicar da melhor forma possível!\n\nPrimeiramente, você precisa saber que o multiverso é uma sequência interminável de estruturas infinitas contidas dentro de outras estruturas infinitas ainda maiores, repetindo-se em escalas cada vez mais insanas como espirais infinitas que continuam se aprofundando sem nunca chegar a porra nenhuma!\n\nNo meio desse emaranhado sem fim, tem uma quantidade infinita de realidades e universos, e essa infinitude não se mostra presente só no número, mas também na extensão, na profundidade e na escala de cada um deles. Todos esses universos se expandem e atravessam espaços tão fodidos que “fim”, “borda”, “vazio” e qualquer outra noção de distância que você tente conceber acabam se tornando coisas menos que insignificantes pra esses caras!\n\nIndo mais adiante, cada um deles abrigam incontáveis camadas de existência que coexistem simultaneamente. Entre elas, há um conjunto incontável de infinitas dimensões espaciais e temporais, responsáveis por sustentar as realidades através de eixos, direções e estruturas que atravessam tudo aquilo que existe. Acima, abaixo e entre essas dimensões, se empilham infinitos planos paralelos, infinitas sub-realidades, infinitas linhas temporais divergentes e infinitos mundos que se dobram uns dentro dos outros. E, dentro dessa caralhada de estruturas, também existem incontáveis galáxias sem fim, sistemas estelares, infinitos universos menores encapsulados em infinitos universos maiores e até estruturas infinitas inteiras escondidas dentro de partículas subatômicas! (Eu nem sabia que uma merda dessas era possível.)\n\nBlá, blá, blá. “Infinito” pra lá, “infinito” pra cá. Blá, blá, blá! Deus, eu repeti esse mesmo termo tantas vezes, né? Acho que um professor de escrita se mataria na minha frente! Maaasss, só posso dar meus pêsames pra ele. Porque não tem outra forma de descrever! É isso que o multiverso é: infinito em todos os sentidos!\n\nEita! Repeti de novo!\n\n“Eu também repeti várias vezes a você pra sair de perto de mim e deixar minha família em paz, seu doen-”\n\nCOOOONTINUANDO!\n\nNesse oceano interminável de possibilidades, cada realidade se sustenta através de suas próprias leis, lógicas e narrativas. Algumas seguem princípios relativamente familiares, espelhando aquilo que nós entendemos como física, lógica e ciência. Outras, no entanto, são completamente alienígenas e esquisitas pra um caralho! Mundos onde o tempo flui em incontáveis direções ao mesmo tempo, universos onde a existência se fragmenta em versões contraditórias de si mesma e realidades onde identidade, matéria e consciência deixam de ser simples ideias fixas!\n\nIncrível, não? Eu sei, eu sei! O multiverso é lindo pra caralho mesmo! Mas.. aposto que você deve estar se perguntando aonde eu quero chegar com tudo isso e o que toda essa droga sobre multiverso tem a ver com essa história, acertei? Acertei!?\n\n“Não. Errou feio. Por favor, só vai embora da minha casa.”\n\nÉ uma pergunta ótima! E a resposta pra ela é bem simples: infinitas possibilidades é igual a infinitas vidas!\n\nOu seja, existem VÁÁÁÁÁRIAS Miskas espalhadas por esse vasto, entediante e lindo multiverso! Cada uma com diferentes vidas, diferentes escolhas, diferentes tragédias, vitórias, fracassos e versões de quem ela poderia ter sido. Algumas versões são quase idênticas à Miska que conhecemos, enquanto outras são tão bizarras que mal poderiam ser reconhecidas como a mesma pessoa!\n\n“Quem caralhos é Mis-”\n\nE, por culpa de um CERTO alguém, a nossa velha e conhecida Miska descobrirá isso ao vivo e a cores.. entrevistando elas!\n\nO que poderia dar errado, não é?\n\nAhem! NÃO É???\n\nPOR QUE VOCÊS LIGARAM PRA POLÍCIA!? EU DISSE PRA NÃO LIGAR!!\n\nO MULTIVERSO É PICA, CACETE! NÃO VAI SOBRAR UM QUE NÃO SAIBA DA BELEZA DELE! NEM VOCÊ AÍ QUE ESTÁ LENDO ISSO!!!"
  },
