...
const dlConfig = {
  ...
  */
  folhas: [
    ...
    sinopse:"O Multiverso. Ahhhh, sim, esse CURIOSO multiverso.\n\nEle é interessante na mesma proporção em que é gigante, e devo dizer que “interessante” é pouca merda pra definir a beleza entediante de tooooooooda sua vastidão eterna. Nele, existe uma quantidade infinita de realidades e universos, não apenas em número, mas também em extensão, profundidade e tamanho.\n\nTodos esses universos se expandem para além de qualquer noção de distância que você tente conceber, atravessando distâncias tão fodidas que “fim”, “borda” ou “vazio” se tornam menos que coisas irrelevantes. Existem também universos que são tão descomunais que fazem outros universos inteiros serem microscópicos quando são comparados com eles, existindo como mera poeira que apenas flutua em algo muito maior.\n\nTá afim de uma dimensão melhor de tudo isso? Bem, cada universo existente abriga incontáveis camadas de existência coexistindo simultaneamente, como, por exemplo, um conjunto não enumerável de infinitas dimensões espaciais e temporais que sustentam cada uma dessas realidade com eixos, direções e estruturas que atravessam tudo o que existe.\n\nAcima, abaixo e entre essas dimensões, se empilham planos paralelos, sub-realidades, linhas temporais divergentes e mundos que se dobram uns dentro dos outros. E, dentro dessa caralhada de estruturas, também existem inúmeras galáxias sem fim, sistemas estelares, universos menores encapsulados em universos maiores e até estruturas inteiras escondidas dentro de partículas subatômicas. (Eu nem sabia que uma merda dessas era possível, pra você ter uma ideia.)\n\nResumindo um pouco, é tudo uma sequência infinita de estruturas contidas dentro de estruturas ainda maiores como espirais infinitas que nunca chegam a porra nenhuma.\n\nBlá, blá, blá “infinito” pra lá, “infinito” pra cá. Eu devo ter repetido esse mesmo termo tantas vezes que eu acho que um professor de escrita se mataria na minha frente.\n\nMas fazer o que? Não tem outra forma de descrever. É literalmente isso.\n\nA propósito, acho bom que você tenha entendido tudo até aqui. Se não entendeu, eu não vou explicar de novo.\n\nCOOOONTINUANDO!\n\nNesse oceano interminável de possibilidades, cada realidade se sustenta através de suas próprias leis, lógicas e narrativas. Algumas seguem princípios relativamente familiares, espelhando aquilo que nós entendemos como física, lógica e ciência. Outras, no entanto, são completamente alienígenas e esquisitas pra um caralho: mundos onde o tempo flui em incontáveis direções ao mesmo tempo; universos onde a existência se fragmenta em versões contraditórias de si mesma; realidades onde identidade, matéria e consciência deixam de ser simples ideias fixas.\n\nMas.. onde eu quero chegar com isso, exatamente? O que toda essa tem a ver com a sinopse dessa história?\n\nÉ simples! Infinitas possibilidades é igual a infinitas vidas!\n\nOu seja, existem VÁÁÁÁÁRIAS Miskas espalhadas por esse vasto e entediante multiverso com diferentes vidas, diferentes escolhas; Diferentes tragédias, vitórias, fracassos e versões de quem ela poderia ter sido. Algumas são quase idênticas à que conhecemos, enquanto outras são tão bizarras que mal poderiam ser reconhecidas como a mesma pessoa.\n\nE, por culpa de um CERTO alguém, a nossa velha e conhecida Miska descobrirá isso ao vivo e a cores.. entrevistando elas!\n\nO que poderia dar errado, não é?\n\nAhem! NÃO É???"
  },
