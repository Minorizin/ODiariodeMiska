...
const dlConfig = {
  ...
  */
  folhas: [
    ...
    sinopse:"No multiverso, existem uma quantidade infinita de realidades e universos, não apenas em número ou extensão, mas também em escala, profundidade e tamanho.\n\nHá universos maiores do que outros universos inteiros poderiam sequer compreender. Cosmos tão vastos que galáxias surgem como partículas insignificantes dentro deles. Estruturas infinitas contidas dentro de outras estruturas infinitas, em camadas que parecem nunca terminar.\n\nDentro desse oceano interminável de possibilidades, cada realidade se sustenta por suas próprias regras, leis e narrativas.\n\nAlgumas seguem princípios familiares, ecoando o que entendemos como física e lógica. Outras, porém, são completamente alienígenas, onde o tempo pode fluir em várias e várias direções; realidades onde a existência se fragmenta em versões contraditórias de si mesma; dimensões onde identidade, matéria e consciência deixam de ser ideias fixas.\n\nOnde eu quero chegar? Vou resumir pra você: Existem várias Miskas espalhadas por aí. E, por culpa de um certo alguém, a nossa velha e conhecida Miska descobrirá isso ao vivo e a cores.. entrevistando elas! O que poderia dar errado, né?\n\n...Né?" },
